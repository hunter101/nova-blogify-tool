...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('index-image-upload-preview', __webpack_require__(6));
    Vue.component('detail-image-upload-preview', __webpack_require__(9));
    Vue.component('form-image-upload-preview', __webpack_require__(12));
});
...
var update = __webpack_require__(16)("9f77718c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c023248a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormField.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c023248a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormField.vue");
...
// module
exports.push([module.i, "\n.uploader[data-v-c023248a] {\n  position: relative;\n  width: 100%;\n  max-width: 600px;\n  height: 300px;\n}\n.preview[data-v-c023248a] {\n  background-size: cover;\n  background-position: center;\n  background-repeat: no-repeat;\n  width: 100%;\n  height: 100%;\n}\n.form-file-input[data-v-c023248a] {\n  width: 100%;\n  height: 100%;\n  opacity: 0;\n  overflow: hidden;\n  position: absolute;\n  cursor: pointer;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__IconButton__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__IconButton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__IconButton__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UploadIcon__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UploadIcon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__UploadIcon__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_laravel_nova__ = __webpack_require__(27);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_3_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_3_laravel_nova__["FormField"]],

    components: { IconButton: __WEBPACK_IMPORTED_MODULE_1__IconButton___default.a, UploadIcon: __WEBPACK_IMPORTED_MODULE_2__UploadIcon___default.a },
    ...
    data: function data() {
        return {
            ...
            missing: false,
            deleted: false,
            uploadErrors: new __WEBPACK_IMPORTED_MODULE_3_laravel_nova__["Errors"]()
        };
    },
    ...
    methods: {
        ...
        fetchImage: function fetchImage() {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_3_laravel_nova__["Minimum"])(axios.get(this.field.thumbnailUrl, {
                responseType: 'blob'
            })).then(function (_ref) {
                ...
                var fileName = _this2.field.value.match(/[^\\/]*$/)[0];
                _this2.fileName = fileName;
                _this2.imagePreview = window.URL.createObjectURL(blob);
         ...
         */
        removeFileOrPreview: function removeFileOrPreview() {
        ...
        removePreview: function removePreview() {
            ...
            this.field.value ? this.removeFile() : this.closeRemoveModal();
        },
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                this.uploadErrors = new __WEBPACK_IMPORTED_MODULE_3_laravel_nova__["Errors"]();
                            ...
                            case 13:
                                ...
                                if (_context.t0.response.status == 422) {
                                    this.uploadErrors = new __WEBPACK_IMPORTED_MODULE_3_laravel_nova__["Errors"](_context.t0.response.data.errors);
                                }
    ...
    computed: {
        uploaderClasses: function uploaderClasses() {
            return ['uploader', 'card', 'overflow-hidden', 'text-60', { 'border-2 border-dashed border-60': !this.imagePreview }];
        },
        previewStyles: function previewStyles() {
            return this.imagePreview ? { backgroundImage: 'url(' + this.imagePreview + ')' } : {};
        },
        ...
        hasImage: function hasImage() {
            return Boolean(this.field.value || this.imagePreview) && !Boolean(this.deleted) && !Boolean(this.missing);
        },
        hasValueButImageMissing: function hasValueButImageMissing() {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48c18036", Component.options)
  } else {
    hotAPI.reload("data-v-48c18036", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48c18036", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/UploadIcon.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3fdae5c5", Component.options)
  } else {
    hotAPI.reload("data-v-3fdae5c5", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3fdae5c5", module.exports)
  }
}
      ...
      _c("template", { slot: "field" }, [
        _c(
          ...
          [
            _c(
              "loading-card",
              { class: _vm.uploaderClasses, attrs: { loading: _vm.loading } },
              [
                _c("input", {
                  ref: "fileField",
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "flex flex-col items-center justify-center w-full h-full z-20"
                  },
                  [
                    _vm.hasImage
                      ? [
                          ...
                          _vm.hasImage
                            ? _c(
                                ...
                                {
                                  staticClass:
                                    "w-full absolute pin-b p-4 flex items-center justify-between text-sm bg-90-half z-20"
                                },
                                [
                                  _c("div", { staticClass: "text-50 " }, [
                                    _vm._v(
                                      "\n                                " +
                      ...
                      : [
                          _c(
                            ...
                            [_vm._v(_vm._s(_vm.__(_vm.uploadLabel)))]
                          ),
                          _vm._v(" "),
                          _c("div", [_c("upload-icon")], 1)
                        ]
                  ],
                  2
                )
            ...
            _vm._v(" "),
            _vm.hasValueButImageMissing
              ? _c("div", { staticClass: "not-found mt-3 text-sm" }, [
                  _c("span", [
                    _c(
                      "a",
                      {
                    ...
                    _vm._v(
                      " " +
                        _vm._s(
                          _vm.__(
                            "has an image, but it could not be found. Try uploading a new one."
                          )
                        ) +
                        "\n                "
                    )
                  ...
                  [
                    _vm.removeModalOpen
                      ? _c("confirm-upload-removal-modal", {
                          on: {
                            confirm: _vm.removeFileOrPreview,
        ...
        _vm._v(" "),
        _vm.hasError
          ? _c("p", { staticClass: "mt-4 text-danger" }, [
